...
const TEMPLATE_VISUAL_CONFIG: Record<string, {
  ...
  'pas': {
    ...
    veoPrompt: (productName, _script) => `UGC selfie video of a person talking to camera about a problem they had, then getting excited as they show ${productName} as the solution. The person starts with a relatable, slightly frustrated energy then transitions to genuine enthusiasm when presenting the product. Natural hand gestures, authentic facial expressions matching the emotional arc from frustration to excitement. Product becomes more prominent as the person gets excited. 9:16 vertical, TikTok style, warm lighting. CRITICAL: The video must have NO text, NO subtitles, NO captions, NO overlays, NO watermarks visible anywhere in the video.`,
  },
  'unboxing': {
    ...
    veoPrompt: (productName, _script) => `UGC selfie video of a person doing an authentic unboxing of ${productName}. They start by showing the package excitedly, then open/reveal the product with genuine surprise and delight. Their hands are active — touching, holding up, examining the product. High energy throughout. The camera is slightly shaky from excitement. Close-ups of the product as they react to quality and details. 9:16 vertical, TikTok #unboxing style, natural indoor lighting. CRITICAL: The video must have NO text, NO subtitles, NO captions, NO overlays, NO watermarks visible anywhere in the video.`,
  },
  'testimonial': {
    ...
    veoPrompt: (productName, _script) => `UGC selfie video of a person giving an honest testimonial about ${productName}. They start with a skeptical, uncertain energy — like they genuinely didn't expect it to work. Then their expression and tone shifts to surprised satisfaction as they share results. The emotional arc goes from doubt to genuine recommendation. Natural, conversational delivery. Holding the product up at the end. 9:16 vertical, TikTok review style, warm indoor lighting. CRITICAL: The video must have NO text, NO subtitles, NO captions, NO overlays, NO watermarks visible anywhere in the video.`,
  },
};
...
const DEFAULT_VISUAL_CONFIG = {
  ...
  veoPrompt: (productName: string, _script: string) => `UGC style selfie video of a person showing ${productName} to camera while speaking naturally. The person looks directly at camera with natural hand gestures, authentic expressions, casual vibe. The person is holding the product visible in frame throughout. 9:16 vertical format, TikTok style, warm natural lighting. CRITICAL: The video must have NO text, NO subtitles, NO captions, NO overlays, NO watermarks visible anywhere in the video.`,
};
