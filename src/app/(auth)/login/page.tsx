...
export default function LoginPage() {
  ...
  return (
    ...
    >
      {error && (
          <div className="p-3 mb-4 text-sm text-status-error bg-status-error/10 rounded-lg border border-status-error/20">
            {error}
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="flex items-center justify-between text-sm">
            <label className="flex items-center gap-2">
              <input
                type="checkbox"
                className="rounded border-border-default bg-deep-space text-electric-indigo focus:ring-electric-indigo"
              />
